...
* 您正在升級NetApp Element 至適用於vCenter Server 4.10、4.9、4.8、4.7、4.6的 4.5或4.4。
...
* * vCenter Server*：您的vCenter外掛程式4.x版已在vCenter Server中註冊。從登錄公用程式（「https://<ManagementNodeIP>:9443`」）選取*登錄狀態*、填寫必要欄位、然後選取*檢查狀態*、以確認vCenter外掛程式已登錄、以及目前安裝的版本編號。
